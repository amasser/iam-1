...
func (*ProvisionRoleRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*ProvisionRoleResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*AssignUserToRoleRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*AssignUserToRoleResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*UnassignUserFromRoleRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func (*UnassignUserFromRoleResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{5} }
...
func (*AssignGroupToRoleRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{6} }
...
func (*AssignGroupToRoleResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{7} }
...
func (*UnassignGroupFromRoleRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{8} }
...
func (*UnassignGroupFromRoleResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{9} }
